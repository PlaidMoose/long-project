...
class QueryBuilder {
    ...
    prepareFields(fields, type = 'where') {
        ...
        const meta = this.metadata.find(this.entityName);
        /* istanbul ignore next */
        const requiresSQLConversion = ((meta === null || meta === void 0 ? void 0 : meta.props) || []).filter(p => { var _a, _b; return ((_a = p.customType) === null || _a === void 0 ? void 0 : _a.convertToDatabaseValueSQL) || ((_b = p.customType) === null || _b === void 0 ? void 0 : _b.convertToJSValueSQL); });
